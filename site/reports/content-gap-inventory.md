# Content gap completion inventory
...
- [ ] `/product/wall-mounted-pull-bar-2/` — Wall mounted pull up Bar (`done`; primary image: `available-local`)
- [ ] `/product/wall-mounted-pull-up-bar/` — Wall mounted pull up bar (`done`; primary image: `available-local`)
