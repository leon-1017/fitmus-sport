...
- [ ] `/product/wall-mounted-rig-2/` — Wall mounted Rig (`pending`; primary image: `available-local`)
- [ ] `/product/wall-mounted-rig-2-2/` — Wall mounted rig 2-2 (`pending`; primary image: `available-local`)
